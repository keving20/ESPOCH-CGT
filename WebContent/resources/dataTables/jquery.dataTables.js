...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "No hay datos disponibles en esta tabla" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default No hay datos disponibles en esta tabla
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default (filtrada de _MAX_ entradas en total)
			 *
			 *  @dtopt Language
